...
def test_simple_go_board():
    game = GoBoard(7)
    game, info, *_ = put_stone(game, "ee")
    game, info, *_ = put_stone(game, "de")
    game, info, *_ = put_stone(game, "cb")
    game, info, *_ = put_stone(game, "fe")
    game, info, *_ = put_stone(game, "ce")
    game, info, *_ = put_stone(game, "ed")
    game, info, *_ = put_stone(game, "dd")
    game, info, *_ = put_stone(game, "ef")
...
def test_ko_move():
    ...
    game, info, *_ = put_stone(game, "dd")
    game, info, *_ = put_stone(game, "ef")
    game, info, done, _ = put_stone(game, "ee")
    assert done.item() == True
